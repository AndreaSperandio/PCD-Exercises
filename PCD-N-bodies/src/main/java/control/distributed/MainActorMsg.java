...
public interface MainActorMsg {
	 ...
	 *
	 */
	public static class CreateBodies implements MainActorMsg {
	 ...
	 *
	 */
	public static class BodiesCreated implements MainActorMsg {
		private final CompletableFuture<Body[]> creationFuture;
	 ...
	 *
	 */
	public static class MoveBodies implements MainActorMsg {
	 ...
	 *
	 */
	public static class ForcesCalculated implements MainActorMsg {
	 ...
	 *
	 */
	public static class BodiesMoved implements MainActorMsg {
		private final CompletableFuture<Body[]> moveFuture;
		private final Body[] bodies;
		private final int from;
	 ...
	 *
	 */
	public static class SetBodies implements MainActorMsg {
		private final Body[] bodies;
