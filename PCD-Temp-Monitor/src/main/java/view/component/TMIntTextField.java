...
public class TMIntTextField extends JFormattedTextField {
	private static final long serialVersionUID = 7532741475194030901L;

	public TMIntTextField() {
		super(TMIntTextField.getFormat());

		this.addFocusListener(new FocusAdapter() {
			@Override
			public void focusGained(final FocusEvent arg0) {
				SwingUtilities.invokeLater(TMIntTextField.this::selectAll); // Select all on focus gained
			}
		});
	}
